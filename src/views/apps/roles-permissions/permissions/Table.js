...
// ** Reactstrap Imports
import { Alert, Button, Col, Form, FormFeedback, Input, Label, Modal, ModalBody, ModalHeader, Row } from 'reactstrap';
import { addPermission, deletePermission, getData, selectPermission, updatePermission } from '../store';
// ** Table Columns
