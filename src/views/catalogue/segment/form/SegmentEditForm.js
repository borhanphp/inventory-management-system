...
import { bindSegmentInfo, getSegmentByFilter, getSegmentById, updateSegment } from "../store"
...
const SegmentEditForm = () => {
  ...
  //   if ( submitted ) {
  //     dispatch( bindSegmentInfo( initialSegmentData ) );
  //     toast.success( 'Segment has been added' );
  //   }
  // }, [submitted] );
  ...
  const handleOnSubmit = () => {
    ...
    dispatch( updateSegment( submittedObj ) )
      .then( ( res ) => {
        if ( res.error ) {
          return;
        } else {
          ...
          navigate( '/catalogue/segment/list' );
          dispatch( bindSegmentInfo( initialSegmentData ) )
              ...
              <FormLayout>
                <FormContentLayout title="Variant Info">
                  ...
                  <div className="mt-1 text-end">
                    <Button type="reset" size="sm" color="secondary" outline onClick={() => { navigate( -1 ) }}>
                      Cancel
                    </Button>
                  </div>
                </FormContentLayout>
            ...
            <Col lg={8}>
              <FormLayout>
                <FormContentLayout title="Variant Values">
                  <div>
                    <div className="w-100" style={{ height: '600px', overflowY: 'auto', overflowX: "hidden" }}>
