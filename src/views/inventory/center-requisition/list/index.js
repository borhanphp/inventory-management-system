...
const RequisitionList = () => {
    ...
    const handleDetails = ( id ) => {
        navigate( '/central-requisition-details', { state: id } )
    }
    const handleApprove = ( id ) => {
        navigate( '/central-requisition-approval', { state: id } )
    }
    ...
    //             dispatch( getAllCentralRequisition( paramObj ) )
    ...
    return (
        <div>
            <ActionMenu
                title='Manage Requisitions ( Central )'
