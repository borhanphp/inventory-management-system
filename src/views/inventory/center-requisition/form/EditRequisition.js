...
import { bindRequisitionInfo, getRequisitionById, updateRequisition } from "../store";
...
const RequisitionEditForm = () => {
    ...
    useEffect( () => {
        dispatch( getRequisitionById( requisitionId ) )
    ...
    const handleOnSubmit = () => {
        if ( !requisitionData?.items?.length ) {
            ...
            dispatch( updateRequisition( submittedData ) )
                .then( () => {
...
export default RequisitionEditForm;