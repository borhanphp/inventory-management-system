...
const PartnerEditForm = () => {
  ...
  const handleOnSubmit = () => {
    ...
    const submittedData = {
      ...
      logoWithDetails: {
        name: logoWithDetails.name ? logoWithDetails.name : logoWithDetails,
      ...
      stamp: {
        name: stamp.name ? stamp.name : stamp,
  ...
  // console.log( 'console.test', partnerBasicInfo?.logo?.replace( 'wwwroot/', '' ) )
